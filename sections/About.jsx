...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Luna" textStyles="text-center" />
...
the convenience of WhatsApp. With Luna, your chats are 
...
responses, managing tasks, and offering insights. Let's 
<span className="font-extrabold text-white"> explore</span> the magic of Luna by 
diving deeper.
      </motion.p>
